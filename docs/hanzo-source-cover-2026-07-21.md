...
## Seven-map targeted-search audit

The targeted corpus is `/opt/data/annotated-maps/direct-source-search/hanzo-targeted/`. All seven files match `SHA256SUMS`, are non-empty on disk, and parse as JSON. They contain 52 returned rows (47 unique video IDs); `neon-junction.json` is a verified, non-empty JSON file whose result array is empty. Every row's exact saved ID, URL, title, channel, duration, and description was inspected. Descriptions in this corpus are saved search-result snippets, so omitted map or hero evidence was not inferred from the query that produced a row.

| Target | File integrity and returned rows | Metadata decision |
|---|---|---|
| Aatlis | `aatlis.json`, 1,986 bytes, SHA-256 `c5be5e8d3482a614b32387d22794906363b19d262d5dc497f048b1ecd2b7eb05`; 1 row: [`NT2X7ZQYJIs`](https://www.youtube.com/watch?v=NT2X7ZQYJIs), **How I got champion 4 on GENJI \| Notes That Might Help You Improve (Overwatch Full gameplay)**, Hiku, 1,040 s. | Reject. The title explicitly identifies Genji and generic full gameplay; the description discusses the creator's games but establishes neither Hanzo nor Aatlis. |
| Neon Junction | `neon-junction.json`, 854 bytes, SHA-256 `0ee45b78bd95b0e79715a0d59b8927589e6793ae233aa5e8f1be5cc1ef10fa5f`; 0 rows. | **No credible returned result**, because the verified search result array is empty. This is not proof that a qualifying source does not exist. |
| New Junk City | `new-junk-city.json`, 3,156 bytes, SHA-256 `6a374be846adab746b02a6430fec5b47e94bd0916428c50b8283218fb3e93d4c`; 2 rows: [`IqwZcC4dL4E`](https://www.youtube.com/watch?v=IqwZcC4dL4E), **I Spent 50 Hours Mastering Freja To PROVE She's The BEST Hero in Overwatch 2**, yeatle, 22,725 s; [`oTUYBD5XjFs`](https://www.youtube.com/watch?v=oTUYBD5XjFs), **ONE OF THE BEST DOOMFIST IN OW 2 - GETQUAKEDON! POTG TOP 500 SEASON 6**, Overwatch Replays, 624 s. | Reject both. Their titles and descriptions explicitly concern Freja and Doomfist respectively; neither saved description establishes New Junk City or Hanzo, and the second is highlight/POTG gameplay. |
| Oasis | `oasis.json`, 23,418 bytes, SHA-256 `bdf4028dcaaaea522496a1b3b97b7b58b456bd915f2a0833f52c32482cce5660`; 20 rows. | Reject all: [`PzSj38amrX0`](https://www.youtube.com/watch?v=PzSj38amrX0) (Ana coaching), [`Wed8vqZSB0U`](https://www.youtube.com/watch?v=Wed8vqZSB0U) (Lifeweaver coaching on Oasis), [`1JfG71pXDEQ`](https://www.youtube.com/watch?v=1JfG71pXDEQ) (Soldier VOD review), [`8ahb8m5r5YU`](https://www.youtube.com/watch?v=8ahb8m5r5YU) (outdated Mercy guide), [`ff40Asfimmo`](https://www.youtube.com/watch?v=ff40Asfimmo) (tank review), [`hfiWlnlFT-M`](https://www.youtube.com/watch?v=hfiWlnlFT-M) (Winston coaching), [`uR2N3OIs53Y`](https://www.youtube.com/watch?v=uR2N3OIs53Y) (Juno educational gameplay), [`pF4KhHFdsvE`](https://www.youtube.com/watch?v=pF4KhHFdsvE) (Soldier coaching), [`spRtIAXq8HQ`](https://www.youtube.com/watch?v=spRtIAXq8HQ) (Ana coaching), [`l5wAHWjY39s`](https://www.youtube.com/watch?v=l5wAHWjY39s) (Widowmaker/Ashe coaching), [`-arRLJjKBjA`](https://www.youtube.com/watch?v=-arRLJjKBjA) (Winston coaching), [`_-a5nLjtSK0`](https://www.youtube.com/watch?v=_-a5nLjtSK0) (Soldier guide; “Hanzo” occurs only in the channel name **A Toxic Hanzo Main**), [`IqwZcC4dL4E`](https://www.youtube.com/watch?v=IqwZcC4dL4E) (Freja gameplay), [`Ev1RE50jR14`](https://www.youtube.com/watch?v=Ev1RE50jR14) and [`q0-hUURdXV8`](https://www.youtube.com/watch?v=q0-hUURdXV8) (Soldier/Reaper coaching), [`MnKUTYRRJKc`](https://www.youtube.com/watch?v=MnKUTYRRJKc) (Ashe VOD review), [`rz3VMSiuzos`](https://www.youtube.com/watch?v=rz3VMSiuzos) (Mei brawl coaching), [`oa4FbCma6Xk`](https://www.youtube.com/watch?v=oa4FbCma6Xk) (Ana/Moira coaching), [`hu4-UKHjH6k`](https://www.youtube.com/watch?v=hu4-UKHjH6k) (Ana coaching), and [`7loFiPjkODU`](https://www.youtube.com/watch?v=7loFiPjkODU) (Baptiste educational gameplay). Only `Wed8vqZSB0U` names Oasis in saved metadata, and it explicitly concerns Lifeweaver. None establishes Hanzo. |
| Paraíso | `paraiso.json`, 22,322 bytes, SHA-256 `67b5a45bdf350f6df5daf4ed78f9cd5ba7cb5a5c8ff7aa3824bf0685604cb26f`; 19 rows. | Reject all: [`kl9UCOHoc4M`](https://www.youtube.com/watch?v=kl9UCOHoc4M) (generic flanking), [`8bgWhH-VZ8s`](https://www.youtube.com/watch?v=8bgWhH-VZ8s) (Doomfist guide), [`uR2N3OIs53Y`](https://www.youtube.com/watch?v=uR2N3OIs53Y) (Juno educational gameplay), [`-YQqEnA6JEQ`](https://www.youtube.com/watch?v=-YQqEnA6JEQ) (generic mechanics), [`hOynqrHlCA8`](https://www.youtube.com/watch?v=hOynqrHlCA8) (generic Push guide), [`z2w20jD0lgQ`](https://www.youtube.com/watch?v=z2w20jD0lgQ) (Widowmaker guide), [`rCgDyu6o34M`](https://www.youtube.com/watch?v=rCgDyu6o34M) (Reinhardt coaching), [`GEQSIgF7s8Y`](https://www.youtube.com/watch?v=GEQSIgF7s8Y) (Mercy educational gameplay), [`HPUk95xNmt4`](https://www.youtube.com/watch?v=HPUk95xNmt4) (Moira gameplay on Circuit Royal), [`79RZS1e9_gU`](https://www.youtube.com/watch?v=79RZS1e9_gU) (Ana coaching), [`tHa4oo_fgCk`](https://www.youtube.com/watch?v=tHa4oo_fgCk) (Brigitte guide), [`Nq6jQoeaY8c`](https://www.youtube.com/watch?v=Nq6jQoeaY8c) (Ana gameplay), [`WQ_JcfZ8czc`](https://www.youtube.com/watch?v=WQ_JcfZ8czc) (generic coaching-session entertainment), [`JeTNBBJF2OE`](https://www.youtube.com/watch?v=JeTNBBJF2OE) (replay-viewer settings), [`LTjE8DphS_g`](https://www.youtube.com/watch?v=LTjE8DphS_g), [`6R4veauaKvs`](https://www.youtube.com/watch?v=6R4veauaKvs), [`BXAdpkg9UGo`](https://www.youtube.com/watch?v=BXAdpkg9UGo), and [`53l0qn9dNsw`](https://www.youtube.com/watch?v=53l0qn9dNsw) (Doomfist gameplay), plus [`drbO3RAWPuE`](https://www.youtube.com/watch?v=drbO3RAWPuE) (Genji gameplay). No saved title or description names Paraíso or establishes Hanzo. |
| Runasapi | `runasapi.json`, 3,122 bytes, SHA-256 `16648ab54935c844429e6e4ba5356f88b9b2d588a8a10e21a7ea5255c30e8a7d`; 2 rows: [`NT2X7ZQYJIs`](https://www.youtube.com/watch?v=NT2X7ZQYJIs), **How I got champion 4 on GENJI \| Notes That Might Help You Improve (Overwatch Full gameplay)**, Hiku, 1,040 s; [`IqwZcC4dL4E`](https://www.youtube.com/watch?v=IqwZcC4dL4E), **I Spent 50 Hours Mastering Freja To PROVE She's The BEST Hero in Overwatch 2**, yeatle, 22,725 s. | Reject both. The saved metadata explicitly concerns Genji and Freja respectively; neither description establishes Runasapi or Hanzo. |
| Suravasa | `suravasa.json`, 9,846 bytes, SHA-256 `736884711fd4f06f29051b29e5241d3a444c44cd680da5daeae536254372af73`; 8 rows. | Reject all. [`gVYzUzgFDvU`](https://www.youtube.com/watch?v=gVYzUzgFDvU), **The Complete Overwatch 2 Flashpoint Guide (All Maps)**, Spilo, 3,236 s, is the closest result: its description explicitly names Aatlis, Suravasa, and New Junk City and its title/description establish educational guide intent, but neither establishes Hanzo. The remaining rows explicitly concern Juno ([`uR2N3OIs53Y`](https://www.youtube.com/watch?v=uR2N3OIs53Y), [`A9iVV8tBid4`](https://www.youtube.com/watch?v=A9iVV8tBid4)), Tracer ([`ysj_kR4z7Ms`](https://www.youtube.com/watch?v=ysj_kR4z7Ms)), Bastion ([`tnF23Hwmr4U`](https://www.youtube.com/watch?v=tnF23Hwmr4U)), Junkrat ([`tarhUJ5N3J0`](https://www.youtube.com/watch?v=tarhUJ5N3J0)), general Invasion information ([`XTLPV5VemcY`](https://www.youtube.com/watch?v=XTLPV5VemcY)), or OWL match analysis ([`DyoY307mEXc`](https://www.youtube.com/watch?v=DyoY307mEXc)); none establishes Hanzo and the exact target map with qualifying intent. |

**Targeted-search acquisition result:** no candidate IDs and therefore no candidate-specific retrieval commands. The revised 30-map counts remain **23 visually identified, 0 acquisition candidates, and 7 still lacking defensible saved map identity**. “No credible returned result” describes only this finite saved corpus; it is not proof of absence on YouTube or elsewhere.
